...
#Initialise
      ...
      var engine1 = engines.Turboprop.new(0 , 0 , 0.2 , 5.21);
      var engine2 = engines.Turboprop.new(1 , 0 , 0.2 , 5.21);
	   var engine3 = engines.Turboprop.new(2 , 0 , 0.2 , 5.21);
      var engine4 = engines.Turboprop.new(3 , 0 , 0.2 , 5.21);
